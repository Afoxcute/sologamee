...
import 'package:solo/board/board.dart';
import 'package:solo/players/collision_details.dart';
import 'package:solo/dice/dice_notifier.dart';
import 'package:solo/board/overlay_surface.dart';
import 'package:solo/util/colors.dart';
import 'package:solo/players/players.dart';
import 'package:solo/result/result.dart';
import 'package:solo/result/result_notifier.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:provider/provider.dart';
import 'package:solo/players/players_notifier.dart';
...
class _soloGameState extends State<soloGame> with TickerProviderStateMixin {
